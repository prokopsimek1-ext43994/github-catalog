...
const hrefs = [
  ...
  },
  {
    label: 'Other',
    items: [
      ['?query=topic:ftoggles', 'Feature Toggles'],
      ['?query=topic:monitoring', 'Monitoring'],
      ['?query=topic:security', 'Security'],
      ['?query=topic:testing', 'Testing'],
      ['?query=topic:tools', 'Tools'],
      ['?query=topic:workflows', 'Workflows'],
    ],
  },
];
